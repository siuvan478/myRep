							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group" style="display: none;">
										...
										<tags:selectbox name="saleTeam" clazz="select2" list="${saleTeams}" style="width: 100%;" multiple="multiple"></tags:selectbox>
									</div>
									<!-- /.form-group -->

									<div class="form-group" style="display: none;">
										<label><spring:message code="report.sale.representative" /></label> 
										<tags:selectbox name="saleRepresentative" clazz="select2" list="${saleRepresentatives}" style="width: 100%;" multiple="multiple"></tags:selectbox>
									</div>
									<!-- channel -->
									<div class="form-group" style="display:none;">
										<label><spring:message code="report.channel.company" /></label> 
										<tags:selectbox name="channels" clazz="select2" list="${channels}" style="width: 100%;" multiple="multiple"></tags:selectbox>
									</div>
									...
									<div class="form-group">
										...
										<select class="form-control select2" name="budget_page" id="budget_page" style="width: 100%;">
											<option selected="selected" value="0,0"><spring:message code="report.all" /></option>
