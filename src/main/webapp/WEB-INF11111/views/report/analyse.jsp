...
<script type="text/javascript">
	$(function() {
	    ...
	    var incomeManageChartData = {
			labels : [ '<spring:message code="report.clo2" />','<spring:message code="report.clo1" />','<spring:message code="report.analyse.campaigns" />' ],
			datasets : [ {
				label : '<spring:message code="report.analyse.sale" />',
				backgroundColor : 'rgba(45,120,176,0.8)',
				data : [  ]
							...
							callbacks : {
								label : function(tooltipItem, data) {
									...
									if(tooltipItem.index == 0){
										//PC
										adTypeLabel = incomeLabel+":"+analyseCurrencySymbol+formatNumber(adTypeData.data[0].income,0,',');
										if(analyseDatas.gpQuery==true){
											adTypeLabel = adTypeLabel+"; "+gpLable+":"+analyseCurrencySymbol+formatNumber(adTypeData.data[0].gp,0,',');
										}
									}else{
										adTypeLabel = adTypeLabel+incomeLabel+":"+analyseCurrencySymbol+formatNumber(adTypeData.data[1].income,0,',');
										if(analyseDatas.gpQuery==true){
											adTypeLabel += "; "+gpLable+":"+analyseCurrencySymbol+formatNumber(adTypeData.data[1].gp,0,',');
										}
									}
