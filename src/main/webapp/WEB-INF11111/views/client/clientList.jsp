        ...
        <c:if test="${msg_modal != null}">
	                    ...
	                    <c:forEach items="${pages.content}" var="client" varStatus="status">
	                    	<tr>
	                    		...
	                    		<td>${client.number}</td>
		                     	...
		                     	<td><fmt:formatDate value="${client.created_at}" pattern="yyyy/MM/dd HH:ss"/> </td>
		                     	...
		                     	<td style="word-break: keep-all;white-space:nowrap;">
		                     		...
		                     		onclick="showModal('${ctx}/ajax/client/approval/modal/${client.id}')">
		                     		<spring:message code="btn.approval" /></button>
		                     	</td>
		                    </tr>
	                    </c:forEach>
          ...
          <script type="text/javascript">
          	$(document).ready(function() {
        		...
        		$("#searchForm #industry_id, #searchForm #state").change(function(){
        			$('#searchForm').submit();
        		});
