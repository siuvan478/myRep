    ...
    <nav class="navbar navbar-static-top ">
        <div class="container">
            <div class="navbar-header">
                <a href="${ctx}/businessOpportunity" class="navbar-brand"><img
                        style="width: 110px;height: 40px;margin-top: -6px;" src="${ctx}/static/images/iclick-logo.png"></a>
            ...
            <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <shiro:hasRole name="admin">
                        <li id="menu_client_Module" class="dropdown">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="${ctx}/setting"><span class="glyphicon glyphicon-cog"></span><spring:message
                                    code="setting.personal"/></a></li>
                            <shiro:user>
                                <shiro:hasAnyRoles name="admin">
                                    <li><a href="${ctx}/setting/tree"><span
                                            class="glyphicon glyphicon-search"></span><spring:message
                                            code='setting.data.sharing.tree'/></a></li>
                                </shiro:hasAnyRoles>
                            </shiro:user>

                            <li><a href="${ctx}/logout"><span class="glyphicon glyphicon-log-out"></span><spring:message
