						...
						<div class="row">
							<div class="col-lg-4">
								<div class="form-group">
									<label for="pay_code"><spring:message code="pay.purpose.code" /></label> 
									<input type="text" class="form-control" id="pay_code" name="pay_code"
										value="<c:out value="${pages.searchMap['pay_code']}"/>"
										placeholder="<spring:message code="pay.purpose.code" />">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table class="table table-striped dataTable table-hover" style="margin-bottom:0px;">
							<thead>
								<tr>
									<th <tags:sort column="pay_code" page="${pages}"/>><spring:message code="pay.purpose.code" /></th>
