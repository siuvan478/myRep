	...
	<div style="padding: 10px;">
		...
		color: #333;pointer-events: auto;padding: 0;" border="1" >
			<tr style="font-size: 20px;">
				<td colspan=15 style="padding: 10px;">客户入账通知-----财务确认打款用</td>
			</tr>
			<tr>
			...
			<tr style="word-break: keep-all;white-space:nowrap;">
				...
				<td style="padding: 8px;" colspan=12>${finConfirmAuditDate}</td>
				<td style="padding: 8px;">财务查账人员：</td>
				<td style="padding: 8px;">${finAuditBy}</td>
			</tr>
			<tr>
		...
		color: #333;pointer-events: auto;">
			<a href="${confirmPayTranURL}">确认完成打款</a>
		</div>
